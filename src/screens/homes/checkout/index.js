...
const CheckOut = props => {
  ...
  var isCheck = props?.route?.params?.value;
  ...
  useEffect(() => {
    ...
    isCheck === true ? setCurrentPosition(2) : setCurrentPosition(currentPosition)
    onCheck === true ? setCurrentPosition(2) : setCurrentPosition(currentPosition)
    const backAction = () => {
                  ...
                  <View style={{ flex: 1 }}>
                    <View style={{ alignSelf: 'center', marginBottom: 50 }}>
                      ...
                      <View
                        ...
                        <Text style={{ color: '#aaa', marginLeft: 3 }}>Address</Text>
                        <TextInput
                  ...
                  <View style={{ flex: 1 }}>
                    <View style={{ alignSelf: 'center' }}>
                      ...
                      <View
                        ...
                        <Text style={{ color: '#aaa', marginLeft: 3, }}>Card Number</Text>
                        <TextInput
